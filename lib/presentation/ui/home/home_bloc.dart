...
class HomeBloc extends BaseBloc {
  ...
  DistrictManager _countyManager;
  ...
  var _mockDataSubject = BehaviorSubject<List<DistrictModel>>();

  Stream<List<DistrictModel>> get mockDataStream => _mockDataSubject.stream;
  ...
  HomeBloc(this._countyManager) {
    disposable.add(_fetchNewDataSubject.stream
        .flatMap((_) => _countyManager.getDistricts())
