...
import 'package:vost/presentation/utils/customized_animated_image.dart';
...
class ProblemReportPage extends StatelessWidget {
  ...
  void _handleEmailClick() async {
    ...
    if (await canLaunch(url)) {
      ...
      showErrorSnackbar(
          "Can not launch email application", scaffoldKey.currentState);
    }
  }
        ...
        child: Padding(
          ...
          child: ListView(
            children: <Widget>[
              ...
              GestureDetector(
                  onTap: _handleEmailClick, child: Text(reportEmail))
            ],
          ),
        ),
      ),
