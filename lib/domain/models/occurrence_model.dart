...
abstract class OccurrenceModel implements Built<OccurrenceModel, OccurrenceModelBuilder> {
  ...
  @nullable ParishModel get parish;

  OccurrenceModel._();
  factory OccurrenceModel([updates(OccurrenceModelBuilder b)]) = _$OccurrenceModel;
}